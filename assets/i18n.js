...
(function(){
  const T = {
    ar: {
      ...
      // ----- SERVICES -----
      'services.eyebrow': 'خدماتنا — SERVICES',
      ...
      'services.s3.h': 'خدمات صيانة وباقات نظافة المطاعم ',
      'services.s3.p': 'تقديم باقات تخدم مختلف انشطة المطاعم من الادارة الى الصيانة وحدمات التنظيف.',
      ...
      // ----- PROJECTS -----
      'projects.eyebrow': 'مشاريعنا — PORTFOLIO',
      ...
      // ----- GROWTH -----
      'growth.eyebrow': 'فلسفتنا — PHILOSOPHY',
      ...
      // ----- WHY -----
      'why.eyebrow': 'لماذا جيلكو — WHY US',
      ...
      'contact.form.email': 'EMAIL / البريد',
      ...
      // ----- CATERING PAGE -----
      'cat.hero.eyebrow': 'CATERING & CENTRAL KITCHEN — الإعاشة والمطبخ المركزي',
      ...
      'cat.leaders.eyebrow': 'LEADERSHIP — فريق الإدارة',
      'cat.leaders.title': 'قيادة <span class="foil">موثوقة</span>',
      'cat.leaders.lede': 'أشخاص حقيقيون يقفون خلف كل قرار تشغيلي — متاحون مباشرة للعملاء والشركاء.',
      'cat.leaders.gm.name': 'مسعود ابو فارس',
      'cat.leaders.gm.role': 'GENERAL MANAGER · المدير العام',
      'cat.leaders.gm.bio': 'المدير العام لمجموعة جيلكو، صاحب القرار التنفيذي لقسم الإعاشة والمطبخ المركزي، ونقطة التواصل الأولى للعملاء والشركاء.',
      'cat.leaders.ceo.name': 'عطاءالله ابو عبدالعزيز',
      'cat.leaders.ceo.role': 'CEO · الرئيس التنفيذي',
      'cat.leaders.ceo.bio': 'الرئيس التنفيذي لمجموعة جيلكو، يقود التوجه الاستراتيجي للاستثمار والتطوير ويضع السياسات العليا لقسم الإعاشة.',
      'cat.leaders.location': '2210 Al Masjid Al Haram Rd, Al Mursalat, Makkah 24247, Saudi Arabia',
      'cat.leaders.wa': 'واتساب مباشر',

      'cat.serve.eyebrow': 'CLIENTS — لمن نقدّم خدماتنا',
      ...
      'cat.pkg.eyebrow': 'PACKAGES — الباقات',
      ...
      'cat.pkg.p1.tier': 'BASIC — الباقة الأساسية',
      ...
      'cat.pkg.p2.tier': 'STANDARD — الباقة القياسية',
      ...
      'cat.pkg.p3.tier': 'PREMIUM — الباقة المتقدّمة',
      ...
      'cat.svc.eyebrow': 'SERVICES — خدمات المطبخ المركزي',
      ...
      'cat.q.eyebrow': 'QUOTE — طلب عرض سعر',
      ...
      'cat.q.name': 'NAME / الاسم',           'cat.q.name.ph': 'اسمك الكريم',
      'cat.q.org': 'ORG / الجهة',             'cat.q.org.ph': 'اسم الشركة أو المشروع',
      'cat.q.phone': 'PHONE / الهاتف',         'cat.q.phone.ph': '+966 5X XXX XXXX',
      'cat.q.email': 'EMAIL / البريد',         'cat.q.email.ph': 'example@email.com',
      'cat.q.service': 'SERVICE / نوع الخدمة',
      ...
      'cat.q.meals': 'MEALS/DAY / عدد الوجبات اليومية', 'cat.q.meals.ph': 'مثال: 500',
      'cat.q.loc': 'LOCATION / الموقع',
      'cat.q.loc.opt1': 'داخل المملكة',
      'cat.q.loc.opt2': 'خارج المملكة',
      'cat.q.city': 'CITY / المدينة',          'cat.q.city.ph': 'مكة المكرمة، الرياض، ...',
      'cat.q.details': 'DETAILS / تفاصيل إضافية', 'cat.q.details.ph': 'مدّة العقد، نوع الموقع، أي ملاحظات خاصة...',
      'cat.q.send': 'إرسال الطلب عبر واتساب',
      'cat.q.hint': 'سيُفتح واتساب المدير العام مع رسالة تحتوي تفاصيل طلبك تلقائياً.',

      'cat.partners.eyebrow': 'PARTNERS — المشاريع والشركاء',
      ...
      'cat.contact.wa.v': '+966 53 515 1341 — مباشر',
    ...
    en: {
      ...
      'cat.contact.phone.ceo': 'PHONE / CEO',
      'cat.contact.wa.k': 'WHATSAPP',
      'cat.contact.wa.v': '+966 53 515 1341 — direct',
