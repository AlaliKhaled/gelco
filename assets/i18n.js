...
(function(){
  const T = {
    ar: {
      ...
      // ----- PARTNER -----
      'partner.title': 'لديك فكرة في تجهيز وتطوير المطاعم و <span class="foil">تبحث له عن مقدم خدمة؟</span>',
      'partner.body': 'نبني خدمات استراتيجية تحوّل الطموح إلى نجاح ملموس. لنصنع الفرصة القادمة معاً.',
      'partner.cta': 'اطلب خدمة الان',
